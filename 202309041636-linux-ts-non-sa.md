...
`swiglsb2db:~ # uptime 20:53pm up 7 days 11:05, 1 user, load average: 19.31, 18.21, 12.10`
...
`swiglsb2db:~ # grep processor /proc/cpuinfo | wc -l 32`
...
```bash
swiglsb2db:~ # lscpu Architecture: x86_64 CPU op-mode(s): 32-bit, 64-bit Byte Order: Little Endian Address sizes: 46 bits physical, 48 bits virtual CPU(s): 32 ...
```

_Note that_ `lscpu` isn't always available.
...
`swiglsb2db:~ # free -h total used free shared buffers cached Mem: 204G 203G 1.2G 116G 40K 201G -/+ buffers/cache: 2.0G 202G Swap: 149G 15M 149G`
